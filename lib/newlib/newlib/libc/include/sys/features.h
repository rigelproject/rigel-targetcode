...
//NOTE Don't define this until libpthread is complete.  newlib's pthread.h
//defines the complete API.  For now, just hack newlib so it defines sched_yield(),
//so we can compile libcxxrt.
//#if defined(RIGEL)
///* Rigel supports pthreads, but does not yet have a notion of OS thread scheduling */
//#define _POSIX_THREADS	1
//#endif
