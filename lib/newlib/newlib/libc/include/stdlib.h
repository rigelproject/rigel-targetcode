...
_VOID	_EXFUN(abort,(_VOID) _NLATTRIBUTE ((noreturn)));
int	_EXFUN(abs,(int));
...
_VOID	_EXFUN(exit,(int __status) _NLATTRIBUTE ((noreturn)));
...
//Rigel FIXME Find a place for __has_feature/__has_extension compatibility layer (see http://clang.llvm.org/docs/LanguageExtensions.html)
#if defined(__clang__)
#if defined(__has_feature) && __has_feature(attribute_deprecated_with_message)
char *  _EXFUN(mktemp,(char *) _NLATTRIBUTE ((deprecated("the use of `mktemp' is dangerous; use `mkstemp' instead"))));
#else
char *  _EXFUN(mktemp,(char *) _NLATTRIBUTE ((deprecated)));
#endif
#else
char *	_EXFUN(mktemp,(char *) _NLATTRIBUTE ((__warning__ ("the use of `mktemp' is dangerous; use `mkstemp' instead"))));
#endif
#endif
...
#if defined(__clang__)
#if defined(__has_feature) && __has_feature(attribute_deprecated_with_message)
char *  _EXFUN(_mktemp_r, (struct _reent *, char *) _NLATTRIBUTE ((deprecated("the use of `mktemp' is dangerous; use `mkstemp' instead"))));
#else
char *  _EXFUN(_mktemp_r, (struct _reent *, char *) _NLATTRIBUTE ((deprecated)));
#endif
#else
char *	_EXFUN(_mktemp_r, (struct _reent *, char *) _NLATTRIBUTE ((__warning__ ("the use of `mktemp' is dangerous; use `mkstemp' instead"))));
#endif
#endif
...
_VOID	_EXFUN(_Exit,(int __status) _NLATTRIBUTE ((noreturn)));
