...
//NOTE We don't want __have_long32 for Rigel, even though our long and int are both 32-bit,
//because it doesn't buy us anything and is sometimes problematic when typedefs conflict.
#elif __STDINT_EXP(LONG_MAX) == 0x7fffffff && !defined(__SPU__) && !defined(RIGEL)
