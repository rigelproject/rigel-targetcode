...
#define _END_STD_C  }
  ...
  ( (__GNUC__ >= 4) || \
    ...
    defined(__clang__) //Rigel NOTE Clang pretends to be GCC 4.2.1 but does support __attribute__ ((nothrow))
...
#ifdef __GNUC__
#define _NLATTRIBUTE(attrs) __attribute__ (attrs)
#else
#define _NLATTRIBUTE(attrs)
#endif
...
#define _ELIDABLE_INLINE extern __inline__ _NLATTRIBUTE ((__always_inline__))
#else
